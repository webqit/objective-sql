...
export default class Savepoint {
     ...
     * @property Array
     */
    get tables_snapshot() { return this.$.details.tables_snapshot; }
     ...
     * @property Bool
     */
    get hasForwardHistory() { return this.$.details.id_active ? true : false; }

    /**
     * @property Bool
     */
    get isRolledback() { return this.$.isRolledback; }
    ...
    async rollback(params = {}) {
        if (!this.name_snapshot && !this.current_name) throw new Error(`Invalid savepoint.`);
        ...
        const errors = {}, noCreateSavepoint = this.direction === 'forward' || this.hasForwardHistory;
