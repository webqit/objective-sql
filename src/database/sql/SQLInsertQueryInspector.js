...
import _InsertQueryInspector from '../_InsertQueryInspector.js';

/**
 * ---------------------
 * The SQLInsertQueryInspector class
 * ---------------------
 */
export default class SQLInsertQueryInspector extends _InsertQueryInspector {
