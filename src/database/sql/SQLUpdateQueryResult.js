...
import _UpdateQueryResult from '../_UpdateQueryResult.js';

/**
 * ---------------------
 * The SQLUpdateQueryResult class
 * ---------------------
 */
export default class SQLUpdateQueryResult extends _UpdateQueryResult {
